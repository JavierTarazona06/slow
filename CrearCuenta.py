...
class VentanaRegistro(VentanaMadre.VentanaMadre):
    ...
    def crearElementos(self):
        ...
        self.botonDevolver.place(x=(self.ancho-1550)/2, y=50)
        ...
        self.tituloCrearCuenta.place(x=(self.ancho-290)/2, y=175)

        self.xCol1, self.yCol1 = 60, 270
        self.xCol1b, self.yCol1b = 235, 275
        self.xCol2, self.yCol2 = 613, 270
        self.xCol2b, self.yCol2b = 788, 275
        self.xCol3, self.yCol3 = 1116, 270
        self.xCol3b, self.yCol3b = 1291, 275
        self.altura = 80

        self.usuarioText = Label(self.base, text="Usuario:", bg="white", font=("",17,"bold"))
        self.usuarioText.place(x=self.xCol1, y=self.yCol1)
        self.usuarioEntrada = Entry(self.base,bg="white",fg="black", justify="left", font=(16), width=25, border=3)
        self.usuarioEntrada.place(x=self.xCol1b, y=self.yCol1b)

        self.contrasenaText = Label(self.base, text="Contraseña:", bg="white", font=("",17,"bold"))
        self.contrasenaText.place(x=self.xCol1, y=self.yCol1+self.altura)
        self.contrasenaEntrada = Entry(self.base,bg="white",fg="black", justify="left", font=(16), width=25, border=3, show="*")
        self.contrasenaEntrada.place(x=self.xCol1b, y=self.yCol1b+self.altura)
        self.contrasenaNota = Label(self.base, text="*De 10 carácteres mínimo e incluya números.", bg="white", fg="red", font=("",8,""), justify="left")
        self.contrasenaNota.place(x=self.xCol1b, y=self.yCol1b+self.altura+25)
        ...
        self.ojoClaveBoton.place(x=self.xCol1b+245, y=self.yCol1b+75)
        ...
        self.numeroDocumentoText.place(x=self.xCol1, y=self.yCol1+self.altura*5-10)
        self.numeroDocumentoEntrada = Entry(self.base,bg="white",fg="black", justify="left", font=(16), width=25, border=3)
        self.numeroDocumentoEntrada.place(x=self.xCol1b, y=self.yCol1b+self.altura*5)

        self.imagenPerfilText = Label(self.base, text="Imagen de\nPerfil:", bg="white", font=("",17,"bold"), justify="left")
        self.imagenPerfilText.place(x=self.xCol1, y=self.yCol1+self.altura*6-10)
        ...
        self.imgPrlBoton.place(x=self.xCol1b, y=self.yCol1b+self.altura*6)
        ...
        self.confirmacionImagenCargada.place(x=self.xCol1b, y=self.yCol1b+self.altura*6+40)
        self.imagenPerfilEntrada = ""

        self.tipoSangreText = Label(self.base, text="Tipo de\nSangre:", bg="white", font=("",17,"bold"), justify="left")
        self.tipoSangreText.place(x=self.xCol2, y=self.yCol2-10)
        self.tipoSangreEntrada = ttk.Combobox(self.base, state="readonly")
        self.tipoSangreEntrada.place(x=self.xCol2b, y=self.yCol2b)
        ...
        self.jefeText.place(x=self.xCol2, y=self.yCol2+self.altura)
        ...
        self.jefeEntrada.place(x=self.xCol2b, y=self.yCol2b+self.altura)
        ...
        self.jefeTextNota.place(x=self.xCol2b, y=self.yCol2b+self.altura+25)

        self.policiasAsignadosText = Label(self.base, text="Policías\nAsignados:", bg="white", font=("",17,"bold"), justify="left")
        self.policiasAsignadosText.place(x=self.xCol2, y=self.yCol2+self.altura*2-10)
        ...
        self.policiasAsignadosEntrada.place(x=self.xCol2b, y=self.yCol2b+self.altura*2)
        ...
        self.policiasAsignadosTextNota.place(x=self.xCol2b, y=self.yCol2b+self.altura*2+25)

        self.asignacionText = Label(self.base, text="Asignación:", bg="white", font=("",17,"bold"), justify="left")
        self.asignacionText.place(x=self.xCol2, y=self.yCol2+self.altura*3)
        self.asignacionEntrada = ttk.Combobox(self.base, state="readonly")
        self.asignacionEntrada.place(x=self.xCol2b, y=self.yCol2b+self.altura*3)
        ...
        self.rolText.place(x=self.xCol2, y=self.yCol2+self.altura*4)
        self.rolEntrada = ttk.Combobox(self.base, state="readonly")
        self.rolEntrada.place(x=self.xCol2b, y=self.yCol2b+self.altura*4)
        ...
        self.hora1Entrada.place(x=self.xCol3b, y=self.yCol3b+self.altura*2, width=35)
        self.hora1Entrada["values"] = self.listaHoras
        self.hora1Entrada.current(0)
        self.sep1 = Label(self.base, text=":", bg="white", font=("",10,"bold"), justify="left").place(x=self.xCol3b+35, y=self.yCol3b+self.altura*2)
        self.minuto1Entrada = ttk.Combobox(self.base, state="readonly")
        self.minuto1Entrada.place(x=self.xCol3b+45, y=self.yCol3b+self.altura*2, width=35)
        self.minuto1Entrada["values"] = self.listaMinutos
        self.minuto1Entrada.current(0)
        self.sep2 = Label(self.base, text="-", bg="white", font=("",10,"bold"), justify="left").place(x=self.xCol3b+80, y=self.yCol3b+self.altura*2)
        self.hora2Entrada = ttk.Combobox(self.base, state="readonly")
        self.hora2Entrada.place(x=self.xCol3b+90, y=self.yCol3b+self.altura*2, width=35)
        self.hora2Entrada["values"] = self.listaHoras
        self.hora2Entrada.current(0)
        self.sep3 = Label(self.base, text=":", bg="white", font=("",10,"bold"), justify="left").place(x=self.xCol3b+125, y=self.yCol3b+self.altura*2)
        self.minuto2Entrada = ttk.Combobox(self.base, state="readonly")
        self.minuto2Entrada.place(x=self.xCol3b+135, y=self.yCol3b+self.altura*2, width=35)
        self.minuto2Entrada["values"] = self.listaMinutos
        self.minuto2Entrada.current(0)
        self.sep4 = Label(self.base, text=" / ", bg="white", font=("",10,"bold"), justify="left").place(x=self.xCol3b+175, y=self.yCol3b+self.altura*2)
        self.hora3Entrada = ttk.Combobox(self.base, state="readonly")
        self.hora3Entrada.place(x=self.xCol3b, y=self.yCol3b+self.altura*2+25, width=35)
        self.hora3Entrada["values"] = self.listaHoras
        self.hora3Entrada.current(0)
        self.sep5 = Label(self.base, text=":", bg="white", font=("",10,"bold"), justify="left").place(x=self.xCol3b+35, y=self.yCol3b+self.altura*2+25)
        self.minuto3Entrada = ttk.Combobox(self.base, state="readonly")
        self.minuto3Entrada.place(x=self.xCol3b+45, y=self.yCol3b+self.altura*2+25, width=35)
        self.minuto3Entrada["values"] = self.listaMinutos
        self.minuto3Entrada.current(0)
        self.sep6 = Label(self.base, text="-", bg="white", font=("",10,"bold"), justify="left").place(x=self.xCol3b+80, y=self.yCol3b+self.altura*2+25)
        self.hora4Entrada = ttk.Combobox(self.base, state="readonly")
        self.hora4Entrada.place(x=self.xCol3b+90, y=self.yCol3b+self.altura*2+25, width=35)
        self.hora4Entrada["values"] = self.listaHoras
        self.hora4Entrada.current(0)
        self.sep7 = Label(self.base, text=":", bg="white", font=("",10,"bold"), justify="left").place(x=self.xCol3b+125, y=self.yCol3b+self.altura*2+25)
        self.minuto4Entrada = ttk.Combobox(self.base, state="readonly")
        self.minuto4Entrada.place(x=self.xCol3b+135, y=self.yCol3b+self.altura*2+25, width=35)
        ...
        self.direccionText.place(x=self.xCol3, y=self.yCol3+self.altura*3)
        self.direccionEntrada = Entry(self.base,bg="white",fg="black", justify="left", font=(16), width=25, border=3)
        self.direccionEntrada.place(x=self.xCol3b, y=self.yCol3b+self.altura*3)
        ...
        self.guardarBoton.place(x=self.xCol3b-65, y=self.yCol3b+self.altura*6)
