                ...
                if seccion3 >= 0:
                    ...
                    if id in car0:
                        ...
                        if vel > 70:
                            ...
                            screenshot = pyautogui.screenshot()
                            # Guardar imagen.
                            pathScreenshot = f"Videos\\video-{id}.png"
                            screenshot.save(pathScreenshot)
                            
                           
                        cv2.rectangle(vi, (x, y), (x + ancho, y + alto), (color), 2)
                    
                    if not id in velocidades:
                        grafica=[id,vel,infractor]
...
Button(ventana, text="Abrir video a detectar", command=abrirVideo).pack()
